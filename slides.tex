...
\begin{frame}[fragile]{Outline}
    \begin{itemize}
        ...
        \item What is Probablistic programming, and when can I use it?
...
\begin{frame}[fragile]{Program optimisation}
    \begin{itemize}
        ...
        \item Intructions are \texttt{Push}, \texttt{Add}, \texttt{Dup}, \texttt{Sub}
        \item Want to automatically discover optimisations
        \item Neural nets do not work - no gradient!
    \end{itemize}
\end{frame}

\begin{frame}[fragile]{Program optimisation Pseudocode}
\begin{columns}
\column{\linewidth}
...
\begin{frame}[fragile]{Probability Distributions: Uniform}
